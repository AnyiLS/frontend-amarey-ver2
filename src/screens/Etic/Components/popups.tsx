		...
		<div>
			<svg
				...
				<defs>
					<style>
						{
							'.a-cuadro{fill:url(#a-cuadro);}.b-cuadro,.c-cuadro,.h-cuadro,.k-cuadro,.l-cuadro,.m-cuadro{fill:#fff;}.c-cuadro,.e-cuadro,.h-cuadro{font-size:24px;}.c-cuadro{font-family:Silka-SemiBold, Silka;font-weight:600;}.d-cuadro,.f-cuadro{fill:#e40032;}.e-cuadro{fill:#182856;}.e-cuadro,.h-cuadro{font-family:Silka-Regular, Silka;}.f-cuadro{font-size:32px;font-family:Silka-Bold, Silka;}.f-cuadro,.j-cuadro,.m-cuadro{font-weight:700;}.g-cuadro,.j-cuadro{fill:#001f5f;}.i-cuadro{fill:rgba(67,67,67,0.09);}.j-cuadro{font-size:42px;font-family:Kiona-Bold, Kiona;}.k-cuadro{stroke:#707070;opacity:0.56;}.l-cuadro{opacity:0.36;}.m-cuadro{font-size:28px;font-family:Helvetica-Bold, Helvetica;}.n-cuadro{stroke:none;}.o-cuadro{fill:none;}.p-cuadro{filter:url(#r-cuadro);}.q-cuadro{filter:url(#p-cuadro);}.r-cuadro{filter:url(#n-cuadro);}.s-cuadro{filter:url(#l-cuadro);}.t-cuadro{filter:url(#j-cuadro);}.u-cuadro{filter:url(#h-cuadro);}.v-cuadro{filter:url(#f-cuadro);}.w-cuadro{filter:url(#d-cuadro);}.x-cuadro{filter:url(#b-cuadro);}'
						}
					</style>
					<pattern
						id="a-cuadro"
