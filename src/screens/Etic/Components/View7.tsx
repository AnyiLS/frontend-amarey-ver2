  ...
  return (
    <svg viewBox="0 40 414 855">
      ...
      <g>
        ...
        <g className="u-reward-2-mobile" transform="matrix(1, 0, 0, 1, -9, 0)">
          <rect
        ...
        <g transform="translate(36 231.364)">
          ...
          >
            <tspan x={selectedLanguage === 'es' ? -125.79 : -105.79} y={20}>
              {t("Incumplimiento de leyes ")}
            </tspan>
            <tspan x={selectedLanguage === 'es' ? -76.786 : -100.786} y={44}>
              {t("y regulaciones")}
            </tspan>
          </text>
          <text
          ...
          >
            ...
            <tspan x={0} y={125}>
              {selectedLanguage === 'es' ? t("y/o procedimientos específicos ") : t("y/o procedimientos específicos ").split(' ').slice(0,4).join(' ')}
            </tspan>
            {selectedLanguage === "en" && (
              <tspan x={0} y={141}>
                {t("establecidos por el Grupo Amarey.").split(' ').slice(4, 10).join(' ')}
              </tspan>
            )}
          </text>
        </g>
