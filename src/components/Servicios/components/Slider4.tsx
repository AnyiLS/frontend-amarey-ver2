		...
		<div className="relative">
			<svg
				...
				<defs>
					<style>
						{
							'.hover:hover .y-item-1820 .c-item-1820, .hover:hover .z-item-1820 .c-item-1820, .hover:hover .w-item-1820 .c-item-1820, .hover:hover .x-item-1820 .c-item-1820, .hover:hover .u-item-1820 .c-item-1820, .hover:hover .v-item-1820 .c-item-1820{fill:#001f5f;}.hover:hover .m-item-1820, .hover:hover .p-item-1820, .hover:hover .o-item-1820{fill: #fff}.a-item-1820,.e-item-1820,.f-item-1820{fill:none;}.b-item-1820,.c-item-1820{fill:#fff;}.b-item-1820{stroke:#707070;}.d-item-1820{clip-path:url(#c-item-1820);}.e-item-1820{stroke:#001f5f;}.e-item-1820,.f-item-1820{stroke-miterlimit:10;stroke-width:3.044px;}.f-item-1820{stroke:#e7002a;}.g-item-1820,.p-item-1820,.q-item-1820{fill:#001f5f;}.g-item-1820{font-size:45px;font-family:Kiona-Bold;font-weight:700;}.h-item-1820{clip-path:url(#d-item-1820);}.i-item-1820{fill:#e40032;}.j-item-1820{mix-blend-mode:multiply;isolation:isolate;}.k-item-1820{fill:#eeebeb;}.l-item-1820{fill:#d6d6d6;}.m-item-1820,.o-item-1820{fill:#182856;}.m-item-1820,.o-item-1820,.p-item-1820{font-size:24px;}.m-item-1820,.p-item-1820{font-family:Silka-Regular, Silka;}.n-item-1820,.o-item-1820{font-family:Silka-SemiBold, Silka;font-weight:600;}.r-item-1820{clip-path:url(#s-item-1820);}.s-item-1820{fill:url(#t-item-1820);}.t-item-1820{filter:url(#q-item-1820);}.u-item-1820{filter:url(#o-item-1820);}.v-item-1820{filter:url(#m-item-1820);}.w-item-1820{filter:url(#k-item-1820);}.x-item-1820{filter:url(#i-item-1820);}.y-item-1820{filter:url(#g-item-1820);}.z-item-1820{filter:url(#e-item-1820);}.aa-item-1820{filter:url(#a-item-1820);}'
						}
					</style>
					<filter
						id="a-item-1820"
				...
				<g transform="translate(0 5.702)">
					...
					<text
						...
						transform="translate(142 40.191)">
						<tspan x={0} y={65}>
							{t('Servicio - 3')}
						</tspan>
						<tspan x={0} y={112}>
					...
					<g className="h-item-1820" transform="translate(0 670.394)">
						<path
					...
					<g style={{ transform: 'translate(195.527px, 240.7px) scale(0.8)' }} className="hover">
						<g
					...
					<g
						className="hover"
						style={{ transform: 'translate(991.413px, 565.033px) scale(0.85)' }}>
						<g
						...
						<text
							...
							<tspan
								x={selectedLanguage === 'es' ? -97.74 : -70.74}
								y={23}>
								{t('Seguimiento por')}
							</tspan>
							<tspan
					...
					<g style={{ transform: 'translate(281px, 565.961px) scale(0.8)' }} className="hover">
					...
					<g style={{ transform: 'translate(245px, 398.831px) scale(0.8)' }} className="hover">
						<g
					...
					<g
            style={{ transform: 'translate(1334.89px, 565.033px) scale(0.85)' }}
						className="hover">
						<g
					...
					<g style={{ transform: 'translate(623.473px, 565.033px) scale(0.85)' }} className="hover">
					...
					<g transform='scale(1.1) translate(-170 -250)'>
						<g
