...
const LifeLine2007: React.FC<ILifeLine2000> = ({
	onClick,
	onLess,
			...
			<g transform="translate(0 46.348)">
				...
				<g style={{ transform: 'translateY(56px)' }}>
					...
					<g className="item-103-g" transform="translate(686.776)">
						<g
							className="item-103-x"
							transform="matrix(1, 0, 0, 1, -686.78, -46.35)">
							<path
					...
					<text
						className="item-103-k"
						transform={
							selectedLanguage === 'es'
								? 'translate(537.856 295.365)'
								: 'translate(537.856 315.365)'
						}>
						<tspan x={0} y={23}>
					...
					<g transform="translate(954.016 212.614)">
						<g
							className="item-103-u"
							transform="matrix(1, 0, 0, 1, -954.02, -258.96)">
							<path
				...
				<g transform="translate(0 -329.714)" onClick={onClick}>
					<g
						className="item-103-v cursor-pointer"
					...
					/>
					<text
						className="item-103-m cursor-pointer"
				...
				<g transform="translate(142 649.861)" onClick={onLess}>
					<g
						className="item-103-s cursor-pointer"
				...
				<g transform="translate(90.016 -322.349)">
					...
					/>
					<text
						className="item-103-q cursor-pointer"
					...
					<text
						className="item-103-qcursor-pointer"
