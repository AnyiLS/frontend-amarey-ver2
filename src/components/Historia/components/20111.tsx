...
const LifeLine20111: React.FC<ILifeLine2000> = ({
	onClick,
	onLess,
		...
		<svg viewBox="0 0 1920 874.839">
			...
			<g transform="translate(0 46.348)">
				...
				<g style={{ transform: 'translateY(56px)' }}>
					...
					<text
						className="item-105-k"
						transform={
							selectedLanguage === 'es'
								? 'translate(531.983 309.365)'
								: 'translate(561.983 309.365)'
						}>
						<tspan x={0} y={23}>
				...
				<g transform="translate(0 -329.714)" onClick={onClick}>
					<g
						className="item-105-v cursor-pointer"
					...
					/>
					<text
						className="item-105-m cursor-pointer"
				...
				<g transform="translate(142 649.861)" onClick={onLess}>
					<g
						className="item-105-s cursor-pointer"
				...
				<g transform="translate(90.016 -322.349)">
					...
					/>
					<text
						className="item-105-q cursor-pointer"
