...
const LifeLine1999: React.FC<ILifeLine1999> = ({
	onClick,
	onLess,
			...
			<g>
				...
				<g transform="translate(0 45.543)">
					...
					<g style={{ transform: 'translateY(56px)' }}>
						...
						/>
						<g
							className="item-101-g"
							transform="translate(686.776)">
							<g
								className="item-101-x"
								transform="matrix(1, 0, 0, 1, -686.78, -45.54)">
								<path
						...
						<text
							className="item-101-k"
							transform="translate(531.983 309.365)">
							<tspan x={0} y={23}>
						...
						<g transform="translate(954.016 212.614)">
							<g
								className="item-101-u"
								transform="matrix(1, 0, 0, 1, -954.02, -258.16)">
								<path
					...
					<g transform="translate(0 -329.714)" onClick={onClick}>
						<g
							className="item-101-v cursor-pointer"
							transform="matrix(1, 0, 0, 1, 0, 284.17)">
							<path
						...
						/>
						<text
							className="item-101-m cursor-pointer"
							transform="translate(1545 1032)">
							<tspan x={0} y={0}>
								{t('Avanzar')}
							</tspan>
						</text>
					...
					<g transform="translate(142 649.861)" onClick={onLess}>
						<g
							className="item-101-s cursor-pointer"
							transform="matrix(1, 0, 0, 1, -142, -695.4)">
							<path
								className="item-101-l cursor-pointer"
					...
					<g transform="translate(90.016 -322.349)">
						<g
							className="item-101-r"
							transform="matrix(1, 0, 0, 1, -90.02, 276.81)">
							<rect
								className="item-101-a"
								width={1406}
								height={79}
						...
						/>
						<text
							className="item-101-q cursor-pointer"
