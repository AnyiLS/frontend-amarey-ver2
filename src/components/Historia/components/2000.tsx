...
const LifeLine2000: React.FC<ILifeLine2000> = ({
	onClick,
	onLess,
		...
		<svg viewBox="0 0 1920 874.839">
			...
			<g>
				...
				<g style={{ transform: 'translateY(56px)' }}>
					<line
						className="item-102-f"
						x2={1465}
						transform="translate(227.5 638.134)"
					/>
					<path
						className="item-102-f"
						d="M0,0H802"
						transform="translate(559 290.134)"
					/>
					<g
						className="item-102-g"
						transform="translate(-471.046 -1512.652)">
						<g
							className="item-102-x"
							transform="matrix(1, 0, 0, 1, 471.05, 1512.65)">
							<path
					...
					<g
						className="item-102-j"
						transform="translate(960 307.869)">
						<path
							className="item-102-a"
					...
					<text
						className="item-102-k"
						transform={
							selectedLanguage === 'es'
								? 'translate(1074 383.634)'
								: 'translate(1054 383.634)'
						}>
						<tspan x={0} y={23}>
					...
					<g transform="translate(-911.287 -1300.038)">
						<g
							className="item-102-u"
							transform="matrix(1, 0, 0, 1, 911.29, 1300.04)">
							<path
				...
				<g transform="translate(0 -283.366)" onClick={onClick}>
					<g
						className="item-102-v cursor-pointer"
						transform="matrix(1, 0, 0, 1, 0, 283.37)">
						<path
					...
					/>
					<text
						className="item-102-m cursor-pointer"
				...
				<g transform="translate(142 696.21)" onClick={onLess}>
					<g
						className="item-102-s cursor-pointer"
						transform="matrix(1, 0, 0, 1, -142, -696.21)">
						<path
							className="item-102-l cursor-pointer"
				...
				<g transform="translate(90.016 -276.001)">
					<g
						className="item-102-r"
						transform="matrix(1, 0, 0, 1, -90.02, 276)">
						<rect
							className="item-102-a"
							width={1406}
							height={79}
					...
					/>
					<text
						className="item-102-q cursor-pointer"
