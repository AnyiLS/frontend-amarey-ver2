...
const LifeLine1984: React.FC<ILifeLine1984> = ({
	onClick,
	handleChangeStepForce,
	t,
}): JSX.Element => {
	return (
		<svg viewBox="0 0 1920 824.49">
			<defs>
				<style>
					{
			...
			<g transform="translate(0 0)">
				...
				<g transform="translate(0)">
					...
					<line
						className="f-lineat"
						x2={1565}
						transform="translate(177.5 641.786)"
					/>
					<path
						className="f-lineat"
						d="M0,0H902"
						transform="translate(529 313.786)"
					/>
					<g className="g-lineat" transform="translate(940.954 80)">
						<g
							className="w-lineat"
					...
					<g style={{ transform: 'translateY(66px)' }}>
