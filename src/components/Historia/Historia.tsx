				...
				<div>
					<svg
						...
						<g transform="translate(0 -100)">
							...
							<text
								className="e-histo"
								transform="translate(837 530)">
								<tspan x={0} y={23}>
									{t(
										'Grupo Amarey es una compañía con más de 40 años de'
									)}
								</tspan>
								<tspan x={0} y={49}>
									{t(
						...
						<g
							className="g-histo"
							transform="translate(1659.069 60.012)">
							<path
								className="h-histo"
