...
const May04: React.FC<ICalendar> = ({
	next,
	prev,
	today,
	onChangeDay,
	...
	return (
		<svg viewBox="-150 0 1920 778.106">
			...
			<text className="i-item-1813" transform="translate(993.979 76.019)">
				<tspan x={0} y={0}>
			...
			<g transform="translate(360 0) scale(0.7)">
				...
				<text
					...
					transform="translate(1568 352.019)">
					<tspan x={-432.404} y={0}>
				...
				<text
					...
					transform="translate(1575	 401.019)">
				...
				<text
					className="r-item-1813"
					transform="translate(1568 634.106)">
					<tspan x={-195.748} y={0}>
						{'VII Congreso'}
					</tspan>
				...
				<text
					className="s-item-1813"
					transform="translate(1578 708.106)">
