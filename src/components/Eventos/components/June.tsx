		...
		<React.Fragment>
			<svg viewBox="-150 0 1920 778.106">
				...
				<path
					...
					style={{ transform: 'scaleY(0.78) scaleX(1) translate(640px, 0px)' }}
				/>
				<g transform="translate(-200.89 -251.981)">
				...
				<text className="h-june" transform="translate(1142.135 76.019)">
					<tspan x={0} y={0}>
						{t('Junio')}
					</tspan>
				</text>
				...
				<g transform="scale(0.7) translate(520 10)">
