...
const May02: React.FC<ICalendar> = ({
	next,
	prev,
	today,
	onChangeDay,
	...
	return (
		<svg viewBox="-150 0 1920 778.106">
			...
			<text className="i-item-1813" transform="translate(988 76.019)">
				<tspan x={0} y={0}>
			...
			<g transform="translate(360 0) scale(0.7)">
				...
				<text
					...
					transform="translate(1565 401.019)">
				...
				<text
					className="s-item-1813"
					transform="translate(1565 708.106)">
