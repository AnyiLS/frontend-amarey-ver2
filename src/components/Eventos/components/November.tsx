...
const November: React.FC<ICalendar> = ({
	next,
	prev,
	onChangeMonth,
	onLessMonth,
			...
			<svg viewBox="-150 0 1920 778.106">
				...
				<g transform="translate(0 -150)">
					...
					<g transform="translate(-140  -133.981)">
						...
						<g
							className="k-november"
							transform="translate(140 610)">
							<g transform="translate(-120  -557)">
								<text
									className="l-november"
									transform="translate(140 557)">
									<tspan x={-13.716} y={23}>
										{'27'}
									</tspan>
				...
				<text
					className="h-november"
					transform="translate(1072.937 76.019)">
					<tspan x={0} y={0}>
						{t('Noviembre')}
					</tspan>
				</text>
