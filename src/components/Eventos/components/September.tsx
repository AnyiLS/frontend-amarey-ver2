...
const September: React.FC<ICalendar> = ({
	next,
	prev,
	onChangeMonth,
	onLessMonth,
	...
	return (
		<React.Fragment>
			<svg viewBox="-150 0 1920 778.106">
				...
				<text
					className="h-september"
					transform="translate(1064.437 76.019)">
					<tspan x={0} y={0}>
						{t('Septiembre')}
					</tspan>
				</text>
				<g transform="translate(351 0) scale(0.7)">
					<g
						className="s-september"
