...
const May18: React.FC<ICalendar> = ({
	next,
	prev,
	today,
	onChangeDay,
		...
		<svg viewBox="-150 0 1920 778.106">
			...
			<g transform="translate(360 0) scale(0.7)">
				...
				<text
					...
					transform="translate(1569 320.106)">
					<tspan x={-381.475} y={0}>
				...
				<text
					...
					transform="translate(1578 420.106)">
				...
				<text
					...
					transform="translate(1004.479 126.019)">
					<tspan x={0} y={0}>
				...
				<text
					className="k-item-1813"
					transform="translate(1574 611.106)">
					<tspan x={-372} y={0}>
				...
				<text
					className="l-item-1813"
					transform="translate(1578 711.106)">
