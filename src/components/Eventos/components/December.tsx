...
const December: React.FC<ICalendar> = ({
	next,
	prev,
	onChangeMonth,
	onLessMonth,
	...
	return (
		<React.Fragment>
			<svg viewBox="-150 0 1920 778.106">
				...
				<text
					className="h-december"
					transform="translate(1079.437 76.019)">
					<tspan x={0} y={0}>
						{t('Diciembre')}
					</tspan>
				</text>
