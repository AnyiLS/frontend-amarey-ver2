...
const Mar06: React.FC<ICalendar> = ({
	month,
	next,
	prev,
	today,
	...
	return (
		<svg viewBox="-150 0 1920 778.106">
			...
			<text className="i-item-1813" transform="translate(1002 76.019)">
				<tspan x={0} y={0}>
			...
			<g transform="translate(360 0) scale(0.7)">
				...
				<text
					...
					transform="translate(1573 340.871)">
					<tspan x={-410.088} y={0}>
				...
				<text
					...
					transform="translate(1568 389.871)">
				...
				<text
					...
					transform="translate(1573 626.106)">
					<tspan x={-390.875} y={0}>
				...
				<text
					className="s-item-1813"
					transform="translate(1568 715.106)">
					<tspan x={-198} y={17}>
