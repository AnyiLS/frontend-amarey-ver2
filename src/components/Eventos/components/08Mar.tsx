		...
		<svg viewBox="-150 0 1920 778.106">
			...
			<g transform="translate(360 0) scale(0.7)">
				...
				<text
					...
					transform="translate(1578 226.106)">
					<tspan x={-390.875} y={0}>
				...
				<text
					...
					transform="translate(1570 315.106)">
					<tspan x={-198} y={17}>
				...
				<text
					className="l-item-1813"
					transform="translate(1578 474.106)">
					<tspan x={-344.25} y={0}>
				...
				<text
					className="m-item-1813"
					transform="translate(1570 539.106)">
					<tspan x={-367.65} y={17}>
				...
				<text
					className="l-item-1813"
					transform="translate(1578 719.106)">
					<tspan x={-176.225} y={0}>
						{'XVI Simposio:'}
					</tspan>
				...
				<text
					className="m-item-1813"
					transform="translate(1578 786.106)">
					<tspan x={-314.64} y={17}>
